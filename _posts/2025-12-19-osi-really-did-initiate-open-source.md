...
qualification to fully square with anecdotal evidence of the term's appearance
prior to OSI's founding, such as [Dieter Plaetinck has
collected](https://dieter.plaetinck.be/posts/open-source-undefined-part-1-the-alternative-origin-story/).
...
in February of 1998. We'll move from broad to specific datasets.
...
source"](https://books.google.com/ngrams/graph?content=open+source%2Cfree+software&year_start=1970&year_end=2022&corpus=en&smoothing=0&case_insensitive=true)
...
{% include img.html src="books.webp" url="https://books.google.com/ngrams/graph?content=open+source%2Cfree+software&year_start=1970&year_end=2022&corpus=en&smoothing=0&case_insensitive=true" %}
...
In the 1980s and 1990s, print magazines were an important venue for
communication. _PC Magazine_, _PC World_, and _Byte_ are the three most
relevant for us with accessible archives. Internet Archive has a partial
archive for the [first](https://archive.org/details/PCMAG). [Vintage
...
{% include img.html src="magazines.webp" %}

The pattern is similar in magazines as in books: effectively nobody was
talking about Open Source until OSI introduced it with the Open Source
Definition.
...
software development. Internet Archive has a 
[historical collection](https://archive.org/details/usenethistorical?tab=collection).

I analyzed the ~53 million posts to the `comp.*` newsgroups from 1986 to 2013.
I found a clear explosion in usage of
the term "open source" at the founding of OSI. 0.004% of posts mentioned the
term pre-OSI, compared with 0.686% post-OSI. That's a 19,282% increase.

{% include img.html src="comp.webp" %}

The conversation in comp.* would have been much more technical than in the
general computing magazines, let alone the Google Books corpus. If there
is one place to expect "open source" to have been "in wide circulation," it
would be here. It wasn't, until OSI came along.
...
Something big happened in 1998. Whatever your opinion of events since, it's
reasonable to accept that the [Open Source Initiative](https://opensource.org/)
founded the [Open Source](https://en.wikipedia.org/wiki/Open_source) movement
with the [Open Source Definition](https://opensource.org/osd).
...
outside the realm of legal recourse. It fits the broader [political economy of
Open Source](https://www.youtube.com/watch?v=lEEP0A1lEU0): in the words of [RFC
2119](https://datatracker.ietf.org/doc/html/rfc2119), we are in the realm not
